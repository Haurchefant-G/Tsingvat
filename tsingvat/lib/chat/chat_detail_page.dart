    ...
    if (controller.text.length > 0) {
      ...
      setState(() {
        ...
        list.add({
          'type': 1,
          'content': text,
          'avatar': "http://121.199.66.17:8800/images/account/zxj/avatar.png"
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            Provide<WebSocketProvide>(builder: (context, child, websocket) {
              list = [];
