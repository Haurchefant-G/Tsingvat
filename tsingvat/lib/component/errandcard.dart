...
class _ErrandCardState extends State<ErrandCard>
  ...
  Future<void> _take() async {
    ...
    try {
      ...
      data = await HttpUtil().put("/errand/take",
          {"uuid": widget.uuid, "taker": taker, "username": widget.createduser});
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child:
                            Icon(Icons.location_on, color: Colors.purple[200]),
                      ),
                      Padding(
                            ...
                            children: <Widget>[
                              DefaultTextStyle(
                                ...
                                child: Column(children: <Widget>[
                                  ...
                                  Text(
                                      "完成点 : ${widget.toAddr} ${widget.stoAddr}")
                                ]),
                              ),
                              ButtonBar(
